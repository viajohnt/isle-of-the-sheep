...
#         off_screen_allowance = 50
#         if self.rect.right > screen.get_width() + off_screen_allowance:
#             self.rect.right = screen.get_width() + off_screen_allowance
#         elif self.rect.left < -off_screen_allowance:
#             self.rect.left = -off_screen_allowance
